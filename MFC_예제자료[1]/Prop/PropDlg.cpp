...
BEGIN_MESSAGE_MAP(CPropDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_BUTT_WIZARD, OnButtWizard)
...
void CPropDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CPropDlg::OnButtPrint() 
{
	// TODO: Add your control notification handler code here
	CMySheet dlg("프로퍼티 시트");
	dlg.DoModal();
}

void CPropDlg::OnButtWizard() 
{
	// TODO: Add your control notification handler code here
	CMySheet dlg("마법사");
	dlg.SetWizardMode();
