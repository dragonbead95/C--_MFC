...
BEGIN_MESSAGE_MAP(CButtonDlg, CDialog)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTT_TITLE, OnButtTitle)
	ON_BN_CLICKED(IDC_BUTT_HIDE, OnButtHide)
	ON_BN_CLICKED(IDC_BUTT_DISABLE, OnButtDisable)
	ON_BN_CLICKED(IDC_BUTT_EXIT, OnButtExit)
	ON_BN_CLICKED(IDC_BUTT_TARGET, OnButtTarget)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CButtonDlg::OnButtExit() 
{
	// TODO: Add your control notification handler code here
	OnOK();
}

void CButtonDlg::OnButtTarget() 
{
	// TODO: Add your control notification handler code here
